...
select
    ...
    {{ dbt.safe_cast("pulocation_id", api.Column.translate_type("integer")) }} as pickup_location_id,
    {{ dbt.safe_cast("dolocation_id", api.Column.translate_type("integer")) }} as dropoff_location_id,
